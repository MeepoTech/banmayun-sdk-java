...
public class UserRole extends Dumpable {

    public String name;
    public String displayValue;

    public UserRole(String name, String displayValue) {
        this.name = name;
    ...
    public static JsonReader<UserRole> Reader = new JsonReader<UserRole>() {

        @Override
        public UserRole read(JsonParser parser) throws IOException, JsonReadException {
            ...
            return new UserRole(name, displayValue);
        }
    };
