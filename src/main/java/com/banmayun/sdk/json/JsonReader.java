...
public abstract class JsonReader<T> {
  ...
  public final T readField(JsonParser parser, String fieldName, T v)
    ...
    if (v != null)
      throw new JsonReadException("duplicate field \"" + fieldName + "\"",
          parser.getTokenLocation());
    return read(parser);
  }

  public final T readOptional(JsonParser parser) throws IOException,
      JsonReadException {
  ...
  public static JsonLocation expectObjectStart(JsonParser parser)
    ...
    if (parser.getCurrentToken() != JsonToken.START_OBJECT) {
      throw new JsonReadException("expecting the start of an object (\"{\")",
          parser.getTokenLocation());
    }
  ...
  public static void expectObjectEnd(JsonParser parser) throws IOException,
      JsonReadException {
    if (parser.getCurrentToken() != JsonToken.END_OBJECT) {
      throw new JsonReadException("expecting the end of an object (\"}\")",
          parser.getTokenLocation());
    }
    nextToken(parser);
  }
  ...
  public static JsonLocation expectArrayStart(JsonParser parser)
    ...
    if (parser.getCurrentToken() != JsonToken.START_ARRAY) {
      throw new JsonReadException("expecting the start of an array (\"[\")",
          parser.getTokenLocation());
    }
    JsonLocation loc = parser.getTokenLocation();
    nextToken(parser);
  ...
  public static long readUnsignedLong(JsonParser parser) throws IOException,
      JsonReadException {
    try {
      long v = parser.getLongValue();
      if (v < 0) {
        throw new JsonReadException("expecting a non-negative number, got: "
            + v, parser.getTokenLocation());
      }
      parser.nextToken();
      return v;
    } catch (JsonParseException ex) {
  ...
  public static long readUnsignedLongField(JsonParser parser, String fieldName,
      long v) throws IOException, JsonReadException {
    if (v >= 0)
      throw new JsonReadException("duplicate field \"" + fieldName + "\"",
  ...
  public static final class FieldMapping {
    ...
    public static final class Builder {
      ...
      public void add(String fieldName, int expectedIndex) {
        if (fields == null)
          throw new IllegalStateException(
              "already called build(); can't call add() anymore");
        int i = fields.size();
        if (expectedIndex != i) {
          throw new IllegalStateException("expectedIndex = " + expectedIndex
              + ", actual = " + i);
        }
      ...
      public FieldMapping build() {
        if (fields == null)
          throw new IllegalStateException(
              "already called build(); can't call build() again");
  ...
  public T readFully(InputStream utf8Body) throws IOException,
      JsonReadException {
    try {
  ...
  public T readFully(String body) throws JsonReadException {
    try {
      ...
      AssertionError ae = new AssertionError(
          "Got IOException reading from String");
      ae.initCause(ae);
      throw ae;
    }
  }
  ...
  public T readFully(byte[] utf8Body) throws JsonReadException {
    try {
      ...
      AssertionError ae = new AssertionError(
          "Got IOException reading from byte[]");
      ae.initCause(ae);
      throw ae;
    }
  }
  ...
  public T readFully(JsonParser parser) throws IOException, JsonReadException {
    ...
    if (parser.getCurrentToken() != null) {
      throw new AssertionError(
          "The JSON library should ensure there's no tokens after the main value: "
